...
const kegiatanData: Kegiatan[] = [
  {
    ...
    image: "/images/kegiatan/mengajar/IMG_20260114_104808.jpeg",
    gallery: [
  ...
  },
  {
    id: 2,
    title:
      "Program Edukasi dan Pembuatan Mineral Block sebagai Suplemen Mineral bagi Ternak",
    shortDesc:
    ...
    image: "/images/kegiatan/mineral_block/IMG_20260121_170329.jpg",
    gallery: [
  ...
  },
  {
    id: 3,
    title:
      "Penyusunan Profil Dukuh Plono Timur Berdasarkan Aspek Kewilayahan, Demografi, Sosial dan Ekonomi.",
    shortDesc:
    ...
    image: "/images/kegiatan/survei_rafa/IMG_20260103_133423.jpg",
    gallery: [
  ...
  },
  {
    ...
    image: "/images/kegiatan/tbm/WhatsApp Image 2026-02-06 at 12.25.50.jpeg",
    gallery: [
  ...
  },
  {
    id: 5,
    title:
      "Pemetaan Kualitas Air dan Zonasi Rawan Longsor sebagai Upaya Mendukung Ketahanan Lingkungan di Kecamatan Samigaluh",
    shortDesc:
    ...
    image: "/images/kegiatan/pemetaan/20260106_155317.jpg",
    gallery: [
  ...
  },
  {
    id: 6,
    title:
      "Sosialisasi Pembuatan Minuman Herbal (Wedang Uwuh) di Dukuh Plono Timur",
    shortDesc:
    ...
    image: "/images/kegiatan/wedang_uwuh/IMG_20260114_151921.jpeg",
    gallery: [
  ...
  },
  {
    ...
    image: "/images/kegiatan/popcorn/IMG_20260113_153300.jpeg",
    gallery: [
...
export default function KegiatanSection() {
  ...
  const prev = (): void => {
    ...
    setIndex((i) => (i - 1 + kegiatanData.length) % kegiatanData.length);
  };
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="md:hidden flex-1 overflow-visible px-2 pb-6">
            <AnimatePresence initial={false} custom={direction} mode="wait">
              <motion.div
                ...
                animate="center"
                exit="exit"
                onClick={() => setPopup(kegiatanData[index])}
        ...
        {/* Popup */}
        {popup && <Popup data={popup} close={() => setPopup(null)} />}
      </div>
    </section>
  );
}
  ...
  return (
    <div
      className={`overflow-hidden rounded-3xl bg-white shadow-lg ${
        mobile ? "max-w-full" : "h-full flex flex-col"
      }`}
    >
      <img
        src={item.image}
        alt={item.title}
        className={`w-full object-cover ${mobile ? "h-64 sm:h-80" : "h-48"}`}
      />

      <div
        className={`${mobile ? "px-6 pt-4 pb-4" : "p-6 flex-1 flex flex-col"}`}
      >
        <h3
          className={`font-bold text-gray-800 ${
            mobile ? "text-lg" : "text-xl min-h-[3.5rem] mb-2"
          }`}
        >
          {item.title}
        </h3>
    ...
    >
      ...
      >
        ...
        <div className="sticky top-0 bg-white border-b px-6 py-4 flex justify-between items-center rounded-t-3xl z-10">
          <h3 className="text-2xl font-bold text-gray-800">Detail Kegiatan</h3>
        ...
        <div className="p-6">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">{data.fullDesc}</p>

          {/* Gallery */}
          <h5 className="text-xl font-semibold mb-4 text-gray-800">Galeri</h5>
